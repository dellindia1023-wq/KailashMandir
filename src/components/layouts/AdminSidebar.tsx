import {
  ...
  Image, Megaphone, CalendarDays, ShieldCheck, Settings, Package, Crown, Shield, UserCircle, BarChart3, Edit3, BookMarked, HelpCircle, Clock, Info, Flag
} from "lucide-react";
...
const contentNav = [
  ...
  { title: "Campaigns", url: "/admin/campaigns", icon: Flag },
