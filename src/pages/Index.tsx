          ...
          <>
            <section ref={revealTestimonials.ref} className={`py-10 md:py-20 bg-background ${revealTestimonials.className}`}>
              <div className="container mx-auto px-4">
                ...
                <div ref={blogStagger.ref} className="hidden md:grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 max-w-5xl mx-auto mb-6">
