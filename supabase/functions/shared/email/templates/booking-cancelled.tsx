...
export const BookingCancelledEmail = ({ recipientName = "Devotee", pujaName = "Puja", refundNote }: BookingCancelledEmailProps) => (
  <EmailLayout title="Booking Cancelled" previewText="Your temple booking has been cancelled successfully.">
    <div>
      ...
      <p style={{ margin: "0 0 16px" }}>Your booking for {pujaName} at Kailash Mandir Agra has been cancelled. If a refund is applicable, it will be processed as per temple policy.</p>
      ...
      <EmailButton href={`${siteUrl}/contact`} label="Contact Temple Support" />
    </div>
  </EmailLayout>
);
