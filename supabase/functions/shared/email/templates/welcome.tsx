...
export const WelcomeEmail = ({ recipientName = "Devotee" }: WelcomeEmailProps) => (
  <EmailLayout title="Welcome to Kailash Mandir Agra" previewText="Welcome to the temple community and experience sacred services with us.">
    <div>
      <p style={{ margin: "0 0 12px" }}>Namaste {recipientName},</p>
      <p style={{ margin: "0 0 16px" }}>
        We are delighted to welcome you to Kailash Mandir Agra. You can now book pujas, make donations, and receive sacred updates directly in your inbox.
      </p>
